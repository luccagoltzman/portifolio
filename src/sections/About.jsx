...
const profilePhoto = "https://avatars.githubusercontent.com/u/61605669?v=4";
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        ...
        >
          <motion.div
            ...
            aria-hidden="true"
          >
            <img src={profilePhoto} alt="Lucca Goltzman" className="w-full h-full object-cover" />
          </motion.div>
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              Especialista em Front-end com mais de 4 anos de experiência criando
              soluções web e mobile eficientes, escaláveis e visualmente impactantes.
              Domino Angular, React, TypeScript e as melhores práticas do mercado.
            </p>

            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl">
              {[
                { label: "Experiência", value: "4+ anos" },
                { label: "Especialidade", value: "Front-end" },
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
              Sou desenvolvedor Front-end e Full Stack, baseado em São Luís, MA.
              Trabalho com aplicações web modernas, responsivas e escaláveis,
              com foco em performance, usabilidade e integração com APIs e bancos de dados.
            </p>
            <p className="mt-4 text-gray-400 text-base sm:text-lg">
              Já atuei em projetos para prefeituras, empresas ambientais e startups,
              entregando interfaces que impactam milhares de usuários.
            </p>
          </motion.div>
        </div>
      </div>
