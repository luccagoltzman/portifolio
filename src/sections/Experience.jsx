...
const experiences = [
  {
    ...
    company: "Agir Ambiental",
    duration: "2023 — Atualmente",
    description:
      "Desenvolvo projetos web e mobile para empresas parceiras, criando interfaces modernas, integrações com APIs e soluções escaláveis com foco em performance e UX.",
  },
  {
    role: "Desenvolvedor Front-end",
    company: "Agenda Acessoria",
    duration: "2022 — 2023",
    description:
      "Atuei no app de Prova de Vida e Holerites da Prefeitura de São Luís, desenvolvendo interfaces responsivas e acessíveis para milhares de usuários.",
  },
  {
    role: "Desenvolvedor Front-end",
    company: "Global Serviços LTDA",
    duration: "2021 — 2022",
    description:
      "Desenvolvi interfaces para o Sistema Previdenciário da Prefeitura de São Luís, implementando novas funcionalidades e melhorias contínuas na experiência do usuário.",
  },
];
