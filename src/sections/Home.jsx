...
const Home = React.forwardRef((props, ref) => {
  const roles = useMemo(
    () => ["Desenvolvedor Front-end", "Desenvolvedor Full Stack", "Web Developer"],
    []
  );
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            >
              Transformo ideias em experiências web modernas, escaláveis e de alto
              impacto — com foco em performance, usabilidade e interfaces que
              fazem a diferença.
            </motion.p>
            ...
            >
              ...
              <a
                href="mailto:luccagoltzman@gmail.com"
